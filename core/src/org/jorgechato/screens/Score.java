...
public class Score implements Screen {
    Texture background, footer , score;
    ImageButton play;
    short scale = 1;
    SpriteBatch b;
    ...
    public void show() {
        ...
        play.setPosition(Gdx.graphics.getWidth() * 0.5f - (420 * 0.5f), Gdx.graphics.getHeight() * 0.4f-play.getHeight()-2*scale);
        b = new SpriteBatch();
    ...
    public void render(float delta) {
        ...
        b.draw(score,Gdx.graphics.getWidth() * 0.5f - (227*scale*0.5f), Gdx.graphics.getHeight() * 0.5f,227*scale,114*scale);
        b.end();
        stage.draw();
    }
